...
incvsdt_as_at_date,
inclm_date_of_event,
incl_identity_card as clo_sort1,
...
AND clo_sort1 >= '" . $clientIdentity . "' AND clo_sort1 <= '" . $clientIdentity . "'
...
<div class="container-fluid">
    ...
    echo "<strong>Total Other Claims Found With Client Identity (".$clientIdentity."): " . $sybase->num_rows($result)."</strong>";
    ?>
    <div class="row">
        <div class="col">
            <table class="table">
                ...
                while ($row = $sybase->fetch_assoc($result)) {
                    ...
                    <tr>
                        <td><a href="claims.php?claimID=<?php echo $row['inclm_claim_serial'];?>" target="_blank"
                            ><?php echo $row['inclm_claim_number']; ?></a></td>
