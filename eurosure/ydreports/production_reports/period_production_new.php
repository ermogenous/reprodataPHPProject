  ...
  <table width="920" border="0" align="center" cellpadding="0" cellspacing="0" class="row_table_border">
    ...
    <tr>
      ...
      <td width="131" rowspan="18" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>Client Name</td>
          <td><input name="extra_client_name" type="checkbox" id="extra_client_name" value="1" <? if ($_POST["extra_client_name"] == 1) echo "checked=\"checked\"";?> /></td>
        </tr>
        <tr>
          <td>Client ID</td>
          <td><input name="extra_client_id" type="checkbox" id="extra_client_id" value="1" <? if ($_POST["extra_client_id"] == 1) echo "checked=\"checked\"";?> /></td>
        </tr>
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
function update_to_field(from_field,to_field) {
    ...
    <tr>
      ...
      <td>From
        ...
        To
      <input name="sort_1_to" type="text" id="sort_1_to" value="<? echo $_POST["sort_1_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_1_from'),this);" /> 
      NOT
    ...
    <tr>
      ...
      <td>From
        ...
        To
      <input name="sort_2_to" type="text" id="sort_2_to" value="<? echo $_POST["sort_2_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_2_from'),this);" />
      NOT
    ...
    <tr>
      ...
      <td>From
        ...
        To
      <input name="sort_3_to" type="text" id="sort_3_to" value="<? echo $_POST["sort_3_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_3_from'),this);" />
      NOT
    ...
    <tr>
      ...
      <td>From
        <input name="sort_4_from" type="text" id="sort_4_from" value="<? echo $_POST["sort_4_from"];?>" size="12" />
        To
      <input name="sort_4_to" type="text" id="sort_4_to" value="<? echo $_POST["sort_4_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_4_from'),this);" />
      NOT
      <input name="sort_4_not" type="checkbox" id="sort_4_not" value="1" <? if ($_POST["sort_4_not"] == 1) echo "checked=\"checked\"";?>/>
      NO GROUP
      <input name="sort_4_not_group" type="checkbox" id="sort_4_not_group" value="1" <? if ($_POST["sort_4_not_group"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
    <tr>
      <td>5: 
      ...
      <td>From
        <input name="sort_5_from" type="text" id="sort_5_from" value="<? echo $_POST["sort_5_from"];?>" size="12" />
        To
      <input name="sort_5_to" type="text" id="sort_5_to" value="<? echo $_POST["sort_5_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_5_from'),this);" />
      NOT
      <input name="sort_5_not" type="checkbox" id="sort_5_not" value="1" <? if ($_POST["sort_5_not"] == 1) echo "checked=\"checked\"";?>/>
      NO GROUP
      <input name="sort_5_not_group" type="checkbox" id="sort_5_not_group" value="1" <? if ($_POST["sort_5_not_group"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
    <tr>
      <td>6: 
      ...
      <td>From
        <input name="sort_6_from" type="text" id="sort_6_from" value="<? echo $_POST["sort_6_from"];?>" size="12" />
        To
      <input name="sort_6_to" type="text" id="sort_6_to" value="<? echo $_POST["sort_6_to"];?>" size="12" onfocus="update_to_field(document.getElementById('sort_6_from'),this);" />
      NOT
      <input name="sort_6_not" type="checkbox" id="sort_6_not" value="1" <? if ($_POST["sort_6_not"] == 1) echo "checked=\"checked\"";?>/>
      NO GROUP
      <input name="sort_6_not_group" type="checkbox" id="sort_6_not_group" value="1" <? if ($_POST["sort_6_not_group"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td>Filter By 
        <select name="filter_by" id="filter_by" style="width:250px">
          ...
          <option value="outer_W_clo_cancel_end_process_status"  <? if ($_POST["filter_by"] == 'outer_W_clo_cancel_end_process_status') echo 'selected=\"selected\"';?>>Cancellation/Endorsement Process status</option>
          <option value="outer_H_Net Premium"  <? if ($_POST["filter_by"] == 'outer_H_Net Premium') echo 'selected=\"selected\"';?>>Net Premium</option>
        </select></td>
    ...
    <tr>
      ...
      <td><select name="per_policy" id="per_policy">
        ...
        <option value="per_commission_type" <? if ($_POST["per_policy"] == 'per_commission_type') echo "selected=\"selected\"";?>>Break Down per Commission Type</option>        
      </select></td>
    </tr>
    <tr>
      <td>Extra Fields</td>
...
<input type="checkbox" name="count_situations" id="count_situations" <? if ($_POST["count_situations"] == 1) echo "checked=\"checked\"";?>/></td>
    ...
    <tr>
      ...
      <td>Add Cresta Zones (must be per loading to work) 
        <input name="cresta_zones" type="checkbox" id="cresta_zones" value="1" <? if ($_POST["cresta_zones"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Show Premium Without Non R/I Perils
        <input name="premium_non_ri_perils" type="checkbox" id="premium_non_ri_perils" value="1" <? if ($_POST["premium_non_ri_perils"] == 1) echo "checked=\"checked\"";?> /></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>Add policy Starting Date/Period Starting Date/First Period Starting Date 
        <input name="policy_dates" type="checkbox" id="policy_dates" value="1" <? if ($_POST["policy_dates"] == 1) echo "checked=\"checked\"";?> /></td>
    </tr>
    <tr>
