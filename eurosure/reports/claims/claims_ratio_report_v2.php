...
<form action="" method="post" id="claims_ratio_form"><table width="670" border="1" align="center">
  ...
  <tr>
    ...
    <td width="378"><select name="break" id="break">
	  <option value="SPR" <?php if ($_POST["break"] == 'ALL') echo "selected=\"selected\"";?>>All Separated</option>
      <option value="ALL" <?php if ($_POST["break"] == 'ALL') echo "selected=\"selected\"";?>>Only Total</option>
      <option value="SPR/ALL" <?php if ($_POST["break"] == 'SPR/GRP') echo "selected=\"selected\"";?>>ALL Separated/Total</option>
      <option value="NON" <?php if ($_POST["break"] == 'NON') echo "selected=\"selected\"";?>>Non Motor</option>
      <option value="MOT,NON" <?php if ($_POST["break"] == 'MOT,NON') echo "selected=\"selected\"";?>>Motor/Non Motor</option>
      <option value="MOT,NON,ALL" <?php if ($_POST["break"] == 'MOT,NON,GRP') echo "selected=\"selected\"";?>>Motor/Non Motor/Total</option>
      <option value="MOT,NON,ALL,SPR" <?php if ($_POST["break"] == 'MOT,NON,GRP') echo "selected=\"selected\"";?>>All Separated/Motor/Non Motor/Total</option>
    </select></td>
...
?>
      <tr>
        ...
        <td width="17%"><input name="preliminary" type="checkbox" id="preliminary" value="1" <?php if ($_POST["preliminary"] == 1) echo "checked=\"checked\"";?> /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input name="withdrawn" type="checkbox" id="withdrawn" value="1" <?php if ($_POST["withdrawn"] == 1) echo "checked=\"checked\"";?> /></td>
      </tr>
      <tr>
        <td><label for="recovery"><strong>Recovery</strong></label></td>
        <td><input name="recovery" type="checkbox" id="recovery" value="1" <?php if ($_POST["recovery"] == 1) echo "checked=\"checked\"";?> /></td>
      </tr>
      <tr>
        <td><label for="closed"><strong>Closed</strong></label></td>
        <td><input name="closed" type="checkbox" id="closed" value="1" <?php if ($_POST["closed"] == 1) echo "checked=\"checked\"";?> /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td><select name="district" id="district">
      <option value="district" <?php if ($_POST["district"] == 'district') echo "selected=\"selected\"";?>>Per District</option>
      <option value="branch" <?php if ($_POST["district"] == 'branch') echo "selected=\"selected\"";?>>Per Branch</option>
    </select></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>From
      <input name="major_from" type="text" id="major_from" value="<?php echo $_POST["major_from"];?>" />
      To
      <input name="major_to" type="text" id="major_to" value="<?php echo $_POST["major_to"];?>" /></td>
    </tr>
  <tr>
    <td><strong>Insurance Type</strong></td>
    <td>From 
      <input name="insurance_type_from" type="text" id="insurance_type_from" value="<?php echo $_POST["insurance_type_from"];?>" />
      To 
      <input name="insurance_type_to" type="text" id="insurance_type_to" value="<?php echo $_POST["insurance_type_to"];?>" /></td>
    </tr>
  <tr>
    ...
    <td><select name="filter_by" id="filter_by">
      ...
      <option value="inity_major_category" <?php if ($_POST["filter_by"] == 'inity_major_category') echo "selected=\"selected\"";?>>Major</option>
    </select>
      <select name="filter_by_type" id="filter_by_type">
        <option value="IN" <?php if ($_POST["filter_by_type"] == 'IN') echo "selected=\"selected\"";?>>IN</option>
        <option value="NOT IN" <?php if ($_POST["filter_by_type"] == 'NOT IN') echo "selected=\"selected\"";?>>NOT IN</option>
      </select>
      <br />
      <textarea name="filter_by_text" id="filter_by_text" cols="45" rows="5"><?php echo $_POST["filter_by_text"];?></textarea></td>
  </tr>
  <tr>
  ...
  ?>
    ...
    <td><label for="year_from">Year</label>
      <input name="year_from" type="number" id="year_from" value="<?php echo $_POST["year_from"];?>" size="6" required style="width:50px">
      <label for="period_from">Period</label>
      <input name="period_from" type="number" id="period_from" value="<?php echo $_POST["period_from"];?>" size="6" required style="width:50px"></td>
    </tr>
  <tr>
    <td><label for="as_at_date"><strong>As At Date</strong></label></td>
    <td><input name="as_at_date" type="text" id="as_at_date" value="<?php echo $_POST["as_at_date"];?>" size="12" required />
      <br />
      UpTo production period and as at date for claims</td>
    </tr>
  <tr>
    <td><strong>Disable Open Date</strong></td>
    <td><input name="open_date" type="checkbox" id="open_date" value="1" <?php if($_POST["open_date"] == '1') echo "checked=\"checked\"";?> /></td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td>From:
      <input name="agents_from" type="text" id="agents_from" size="9" value="<?php echo $_POST["agents_from"];?>" />
      To:
      <input name="agents_to" type="text" id="agents_to" size="9" value="<?php echo $_POST["agents_to"];?>" /></td>
    </tr>
  <tr>
    <td align="left"><strong>Agents Code By</strong></td>
    <td align="left"><select name="agents_code_by" id="agents_code_by">
      <option value="agent_group_code" <?php if ($_POST["agents_code_by"] == 'agent_group_code') echo "selected=\"selected\"";?>>Agent Group Code</option>
    </select></td>
    </tr>
  <tr>
    <td align="center">&nbsp;</td>
  ...
  <tr>
    <td>Fees</td>
    <td><input name="fees" type="checkbox" id="fees" value="1" <?php if ($_POST["fees"] == 1) echo "checked=\"checked\"";?> /></td>
    </tr>
  <tr>
    <td>Commissions</td>
    <td><input name="commission" type="checkbox" id="commission" value="1" <?php if ($_POST["commission"] == 1) echo "checked=\"checked\"";?> /></td>
    </tr>
  <tr>
    <td>Stamps</td>
    <td><input name="stamps" type="checkbox" id="stamps" value="1" <?php if ($_POST["stamps"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
  <tr>
    <td>MIF</td>
    <td><input name="mif" type="checkbox" id="mif" value="1" <?php if ($_POST["mif"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
  <tr>
    <td>Reinsurance</td>
    <td><input name="reinsurance" type="checkbox" id="reinsurance" value="1" <?php if ($_POST["reinsurance"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
  <tr>
    <td>Expenses</td>
    <td><input name="expenses" type="checkbox" id="expenses" value="1" <?php if ($_POST["expenses"] == 1) echo "checked=\"checked\"";?>/></td>
    </tr>
  <tr>
    <td>Exp/Profit</td>
    <td><input name="profit" type="checkbox" id="profit" value="1" <?php if ($_POST["profit"] == 1) echo "checked=\"checked\"";?>/>
      Includes Earned Unearned </td>
    </tr>
  <tr>
    <td>Product Prem % </td>
    <td><input name="premium_percentage" type="checkbox" id="premium_percentage" value="1" <?php if ($_POST["premium_percentage"] == 1) echo "checked=\"checked\"";?>/>
      % of class based on the total premium</td>
    </tr>
  <tr>
    <td><input name="action" type="hidden" id="action" value="show">
    Show Only
      <input name="show_only" type="checkbox" id="show_only" value="1" <?php if ($_POST["show_only"] == 1) echo "checked=\"checked\"";?> />
