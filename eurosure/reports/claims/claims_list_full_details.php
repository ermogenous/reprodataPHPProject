...
<form name="form1" method="post" action="">
  <table width="564" border="0" align="center" cellpadding="0" cellspacing="0" class="row_table_border">
    ...
    <tr>
      ...
      <td width="410"><input name="as_at_date" type="text" id="as_at_date" value="<?php echo $_POST["as_at_date"];?>">
      YYYY-MM-DD</td>
    </tr>
    ...
    <tr>
      ...
      <td>Year From
        <input name="from_year" type="text" id="from_year" size="5" value="<?php echo $_POST["from_year"];?>" />
        Period From
        <input name="from_period" type="text" id="from_period" size="3" value="<?php echo $_POST["from_period"];?>" /></td>
    </tr>
    <tr>
      <td height="28">Period/Year To</td>
      <td>Year To
        <input name="to_year" type="text" id="to_year" size="5" value="<?php echo $_POST["to_year"];?>" />
        Period To
      <input name="to_period" type="text" id="to_period" size="3" value="<?php echo $_POST["to_period"];?>" /></td>
    </tr>
    <tr>
      <td height="28">Claim Open Date </td>
      <td>From
        <input name="open_date_from" type="text" id="open_date_from" size="10" value="<?php echo $_POST["open_date_from"];?>" />
        To 
      <input name="open_date_to" type="text" id="open_date_to" size="10" value="<?php echo $_POST["open_date_to"];?>"/></td>
    </tr>
    <tr>
      <td height="28">Insurance Type  </td>
      <td>From
        <input name="klado_from" type="text" id="klado_from" value="<?php echo $_POST["klado_from"];?>" size="8" />
To
<input name="klado_to" type="text" id="klado_to" value="<?php echo $_POST["klado_to"];?>" size="8" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><select name="policy_cover" id="policy_cover">
	    <option value="ALL" <?php if ($_POST["policy_cover"] == 'ALL') echo "selected=\"selected\"";?>>ALL</option>
        <option value="A" <?php if ($_POST["policy_cover"] == 'A') echo "selected=\"selected\"";?>>Thirt Party</option>
        <option value="B" <?php if ($_POST["policy_cover"] == 'B') echo "selected=\"selected\"";?>>Fire &amp; Theft</option>
        <option value="C" <?php if ($_POST["policy_cover"] == 'C') echo "selected=\"selected\"";?>>Comprehensive</option>
        <option value="D" <?php if ($_POST["policy_cover"] == 'D') echo "selected=\"selected\"";?>>Fire &amp; Theft + Comprehensive</option>
      </select>      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><input name="export_file" type="radio" value="no" <?php if ($_POST["export_file"] == "no") echo "checked=\"checked\"";?> />
No
  <input name="export_file" type="radio" value="delimited" <?php if ($_POST["export_file"] == "delimited") echo "checked=\"checked\"";?> />
Delimited (#)
<input name="export_file" type="radio" value="totals" <?php if ($_POST["export_file"] == "totals") echo "checked=\"checked\"";?> />
Show Totals  </td>
    </tr>
    <tr>
      <td height="28">What to show</td>
      <td><select name="what_to_show" id="what_to_show">
        <option value="ALL"<?php if ($_POST["what_to_show"] == 'ALL') echo "selected=\"selected\"";?>>All</option>
        <option value="DRIVERS"<?php if ($_POST["what_to_show"] == 'DRIVERS') echo "selected=\"selected\"";?>>Only Drivers</option>
      </select></td>
    </tr>
    <tr>
...
<table width="760" border="1" cellspacing="0" cellpadding="0" align="center" class="main_text">
  <tr>
    <td width="204"><strong><?php echo $name;?></strong></td>
...
?>
  <tr>
    ...
    <td align="center"><?php echo $sec_value["Cost"];?></td>
    <td align="center"><?php echo $sec_value["Count"];?></td>
