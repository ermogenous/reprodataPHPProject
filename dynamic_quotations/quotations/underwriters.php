        ...
        <div class="table-responsive">
            <table class="table table-hover">
                ...
                <tr class="alert alert-success">
                    ...
                    <th width="37" align="left"><?php $table->display_order_links('UserID', 'usr_users_ID'); ?></th>
                    <th width="300" align="left"><?php $table->display_order_links('Name', 'usr_name'); ?></th>
                ...
                while ($row = $table->fetch_data()) {
                    ...
                    <tr onclick="editLine(<?php echo $row["oqun_quotations_underwriter_ID"]; ?>);">
                        ...
                        <td align="left"><?php echo $row["usr_users_ID"]; ?></td>
