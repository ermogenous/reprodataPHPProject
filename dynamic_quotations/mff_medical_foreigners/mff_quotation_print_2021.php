...
//section 1 ========================================================================================================================================SECTION 1
    ...
    $startDateParts = explode('-', explode(' ', $quotationData['oqq_effective_date'])[0]);
    ...
    if ($quotationData['oqq_status'] != 'Active') {
        ...
        $draft = '';
        $draftImage = '';
        $signature = '<img src="images/santamas_signature_200.png" width="130">';
        $stamp = '<img src="'.$db->admin_layout_url.'images/full_stamp_signature_2021b.jpg" width="100">';
...
<div style="font-family: Tahoma; ' . $draftImage . '">
    ...
    <table class="tableTdBorder" width="900" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            The benefit is payable only if delivery takes place at least 10 months from the commencement of cover or 
            inclusion of the Insured Person in the Policy. Το ωφέλημα είναι πληρωτέο νοουμένου ότι ο τοκετός γίνεται 
            τουλάχιστον 10 μήνες μετά την έναρξη του Ασφαλιστηρίου ή την ένταξη του Ασφαλισμένου Προσώπου στο Ασφαλιστήριο
            </td>
    ...
    <div style="font-size: 10px; width: 900px; text-align: justify;">
        This <b>Schedule of Benefits</b> forms an integral part of <b>Medical Insurance Policy KMIPW 07 2021</b> 
        This Policy will be renewed for an 
        ...
        / <b>Ο Πίνακας Παροχών</b> αποτελεί αναπόσπαστο μέρος του <b>Ασφαλιστηρίου Ιατροφαρμακευτικής Περίθαλψης KMIPW 07 2021</b> Το Ασφαλιστήριο 
    ...
    <div style="font-size: 10px;">
        <table style="font-size: 10px;" width="100%">
            ...
            <tr>
                ...
                <td align="center">
                    ' . $stamp . $draft . '<br>
                    Issue Date / Ημερομηνία Έκδοσης: <br>'
        . $db->convert_date_format($quotationData['oqq_effective_date'], 'yyyy-mm-dd', 'dd/mm/yyyy', 1, 1) . '
                </td>
            </tr>
        </table>
    </div>
