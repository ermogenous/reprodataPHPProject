    ...
    <table width="900" style="font-size: 12px; '.$draftImage.'">
        ...
        <tr>
            <td colspan="3" align="justify">
                ...
                B0750RARSP2000822 and that the said Underwriters have undertaken to Issue Policy/Policies of Insurance 
                to cover up to EUR1.500.000 (or equivalent in other currencies), in all by any one approved steamer(s) 
            ...
            <td colspan="3">
                <table width="100%">
                    <tr>
                        ...
                        <td width="25%">' . $sect1['oqqit_rate_6'] . '</td>
                        <td width="6%">From:</td>
                        <td width="25%">' . $sect1['clo_country_from'] . $approvalFromCountry.' - '.$sect1['oqqit_rate_14'].'</td>
                        <td width="18%"></td>
                        <td width=""></td>
                    </tr>
                    <tr>
