        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                if ($_SESSION[$main["environment"] . "_logged_in"] == 1) {
                    ...
                    <li class="nav-item">
                        <a class="nav-link"
                           href="<?php echo $main["site_url"]; ?>/synthesis/syn_login.php?action=logout"><i
                    ...
                    if (strpos($_SESSION['synthesis_menu'], 'ST,') !== false) {
                        ...
                        <li class="nav-item">
                            <a class="nav-link"
                               href="<?php echo $main["site_url"]; ?>/synthesis/inventory/inventory.php">
                    ...
                    <!-- USERS -->
                    <?php
                    if (strpos($_SESSION['synthesis_menu'], 'Admin,') !== false) {
                        ?>
                    ...
                    if (strpos($_SESSION['synthesis_menu'], 'Admin,') !== false) {
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/synthesis/companies/companies.php"><i
                                            class="fas fa-eye"></i> View Companies</a>
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/synthesis/companies/company_modify.php"><i
                    ...
                    ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/synthesis/web_users/web_users.php"><i
                                            class="fas fa-eye"></i> View Web Users</a>
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/synthesis/web_users/web_user_modify.php"><i
                                            class="fas fa-plus-circle"></i> New Web Users</a>
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/synthesis/web_users/update_web_users.php"><i
                                            class="fas fa-plus-circle"></i> Update Web Users</a>
                            </div>
                        </li>
                    <?php } ?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <?php
                            echo $_SESSION['synthesis_description'] . "(" . $_SESSION['synthesis_menu'] . ")";
                            ?>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12 text-center">
                            Copyright Synthesis 2020. All rights reserved. Developed & Hosted by Ermogenous.M
                        </div>
                    </div>
                    <div class="row" style="height: 5px;"></div>
                </div>
