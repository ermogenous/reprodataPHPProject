...
function template_header()
{
    ...
    <head>
        <meta charset="UTF-8">
        <title>Body Therapy System - Cyprus</title>
        <LINK REL="SHORTCUT ICON" HREF="<?php echo $db->admin_layout_url; ?>images/therapy_logo.png">
    ...
    <nav class="navbar navbar-expand-lg navbar-mycustom">
        &nbsp;&nbsp;&nbsp;
        <img src="<?php echo $db->admin_layout_url; ?>images/therapy_logo.png" height="40">
        &nbsp;&nbsp;&nbsp;
            ...
            <ul class="navbar-nav mr-auto">
                ...
                if ($_SESSION[$main["environment"] . "_admin_username"] != "") {
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/customers/customers.php">
                                <i class="far fa-eye"></i> View Customers</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/customers/customers_modify.php">
                                <i class="fas fa-plus"></i> New Customer</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/customers/customer_groups.php">
                                <i class="far fa-eye"></i> View Group</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/customers/customer_groups_modify.php">
                                <i class="fas fa-plus"></i> New Group</a>
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="fas fa-grip-horizontal"></i> Therapies
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/therapy/therapies.php.php">
                                <i class="far fa-eye"></i> View Therapies</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/therapy/therapy_modify.php">
                                <i class="fas fa-plus"></i> New Therapy</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/therapy/therapy_types.php">
                                <i class="fas fa-grip-vertical"></i> Therapy Products</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/therapy/therapy_types.php">
                                <i class="fas fa-grip-vertical"></i> Therapy Sub Products</a>
                            <a class="dropdown-item"
                               href="<?php echo $main["site_url"]; ?>/therapy/question_list.php">
                                <i class="far fa-question-circle"></i> Consultation Questionnaire List</a>
                        </div>
                    </li>
