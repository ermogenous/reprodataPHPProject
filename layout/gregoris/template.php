                ...
                if ($_SESSION[$main["environment"] . "_admin_username"] != "") {
                    ...
                    if ($db->user_data['usr_user_rights'] < 8) {
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fab fa-product-hunt"></i> <?php echo $db->showLangText('Products', 'Προιόντα'); ?>
                                <i class="fas fa-caret-down"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/products/products.php"><i
                                            class="fas fa-eye"></i> <?php echo $db->showLangText('View Products', 'Προβολή Ποιόντων'); ?>
                                </a>
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/products/product_modify.php"><i
                                            class="fas fa-plus-circle"></i> <?php echo $db->showLangText('New Product', 'Δημιουργία Προϊόν'); ?>
                                </a>
                    ...
                    if ($db->user_data['usr_user_rights'] < 8) {
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <i class="fas fa-file-invoice-dollar"></i> <?php echo $db->showLangText('Invoices', 'Τιμολόγια'); ?>
                                <i class="fas fa-caret-down"></i>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/basic_invoices/invoices/invoices.php"><i
                                            class="fas fa-eye"></i> <?php echo $db->showLangText('View Invoices', 'Προβολή Τιμολογιών'); ?>
                                </a>
                                <a class="dropdown-item"
                                   href="<?php echo $main["site_url"]; ?>/basic_invoices/invoices/invoice_modify.php"><i
                                            class="fas fa-plus-circle"></i> <?php echo $db->showLangText('New Invoice', 'Δημιουργία Τιμολογίου'); ?>
                                </a>
