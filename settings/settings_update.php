                ...
                <form name="myForm" id="myForm" method="post" action="" onsubmit="">
                    ...
                    <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select name="fld_layout_show_footer_stats" id="fld_layout_show_footer_stats"
                                            class="form-control"
                                            required>
                                        <option value="Yes" <?php if ($footerShowStats == 'Yes') echo 'selected'; ?>>
                                            Show
                                            stats on footer
                                        </option>
                        ...
                        <div class="tab-pane fade show" id="pills-addons" role="tabpanel"
                            ...
                            ?>
                            <div class="form-group row">
                                <label for="fld_agr_agreement_number_last_used" class="col-sm-4 col-form-label">Last
                                    Number
                                    Used</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <label for="fld_agr_agreement_status_on_insert" class="col-sm-4 col-form-label">Status
                                    On
                                    Insert</label>
                                <div class="col-sm-8">
                            ...
                            ?>
                            <div class="form-group row">
                                <label for="fld_sch_schedule_number_last_used" class="col-sm-4 col-form-label">Last
                                    Number
                                    Used</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <label for="fld_stk_stock_enable">
                                        ...
                                        <input type="checkbox" title="Bring On Startup" value="1"
                                               id="startup_fld_ina_enable_agent_insurance"
                                               name="startup_fld_ina_enable_agent_insurance"
                                            <?php if ($db->get_setting('ina_enable_agent_insurance', 'startup') == 1) echo 'checked'; ?>>
                                    </label>
                                </div>
                                <div class="col-sm-7">
                                    <input type="hidden" name="fld_ina_enable_agent_insurance"
                                           id="fld_ina_enable_agent_insurance"
