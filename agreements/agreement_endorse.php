...
$db = new Main();
$db->admin_title = "Agreements Endorse";

if ($_POST['action'] == 'endorse') {
    $agr = new Agreements($_POST['lid']);

    $newID = $agr->endorseAgreement($db->convert_date_format($_POST['fld_starting_date'], 'dd/mm/yyyy', 'yyyy-mm-dd'));
            ...
            <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                <form name="myForm" id="myForm" method="post" action="" onsubmit="">
                    ...
                    if ($newID > 0) {
                        ...
                        ?>
                        <div class="form-group row">
                            <div class="col-2 font-weight-bold">Endorsement Date</div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                <?php echo $db->convert_date_format($data["agr_expiry_date"], 'yyyy-mm-dd', 'dd/mm/yyyy'); ?>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="form-group row">
                        <div class="col-12 text-center">
                            ...
                            <?php if ($newID > 0) { ?>
                                <input type="button" value="Open Endorsement" class="btn btn-success"
    ...
    <script>
        function submitForm() {
            ...
            if (frm.checkValidity() === false) {
                ...
                if (confirm('Are you sure you want to endorse this agreement?')) {
